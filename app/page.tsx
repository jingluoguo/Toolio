  ...
  return (
    <main className="portal-page min-h-screen overflow-hidden bg-[#F4F1EA] text-[#16252E]">
      ...
      <header className="relative z-10 mx-auto flex max-w-[1440px] items-center justify-between px-6 py-6 md:px-10 lg:px-16">
        <a href="/" className="flex items-center gap-3" aria-label="Toolio 首页"><span className="grid h-9 w-9 place-items-center rounded-full bg-[#142B36] text-[11px] font-semibold tracking-[0.18em] text-[#F4E3BA]">T</span><span className="font-serif text-xl tracking-[0.08em]">TOOLIO</span></a>
        <nav className="hidden items-center gap-8 text-sm text-[#53616A] md:flex"><a href="#tools" className="border-b border-[#AD9363] pb-1 text-[#16252E]">工具集</a><a href="#about" className="transition-colors hover:text-[#16252E]">关于我们</a><a href="/wheel" className="inline-flex items-center gap-1 transition-colors hover:text-[#16252E]">打开转盘 <ArrowUpRight size={14} /></a></nav>
